      ...
      <div className=" flex flex-col ">
        <div className="-my-2 -mx-4 sm:-mx-6 lg:-mx-8">
          <div className=" min-w-full py-2 align-middle">
            <div className="ring-1 max-h-[65vh] overflow-x-auto w-auto ring-opacity-5 md:rounded-lg shadow bg-white ">
              <table className="min-w-full table-fixed divide-y w-auto divide-gray-300 ">
                {razas.length === 0 ? (
                  <span></span>
                ) : (
                  <>
                    <thead className="text-center divide-y top-0 z-50 bg-white   dark:bg-neutral-800 dark:text-white">
